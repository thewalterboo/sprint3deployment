...
class Pages:
    ...
    # Write the title and the subheader
        ...
        components.html('<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/2GrafQPopdSdPobRxU6OST?utm_source=generator&theme=0" width="100%" height="600" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>',width=None, height=700, scrolling=False)
